...
@click.command()
@click.option("--min", help="min number for random generation", required=True, type=click.INT)
@click.option("--max", help="max number for random generation", required=True, type=click.INT)
